...
2026-06-05 기준으로 1~11단계 구현과 커밋을 완료했다.

- Vue 공통 레이아웃, Router, Pinia 세션 store 구성
- 세션 기반 Axios API composable 구성
- 로그인/회원가입/로그아웃 화면 전환
- 식단 목록/상세/등록/수정/삭제 화면 전환
- 프로필 조회/수정/비활성화/삭제 화면 전환
- 홈/코치 대시보드 화면 전환
- 커뮤니티 게시글/댓글 CRUD 화면 전환
